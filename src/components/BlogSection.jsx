function BlogSection({ blogs }) {
  return (
    <section className="mx-auto w-full max-w-[960px] px-6 py-14 text-center">
      <h3 className="m-0 text-[48px] leading-[1.05] max-[920px]:text-[34px]">Blog</h3>

      <div className="mt-[26px] grid grid-cols-3 gap-4 max-[920px]:grid-cols-2 max-[560px]:grid-cols-1">
        {blogs.map((post) => (
          <article key={post.title} className="flex min-h-[380px] flex-col text-left">
